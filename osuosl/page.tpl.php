...
<!-- OSU identity --><div style="margin: auto; width: 100%; height: 42px; background-color: rgb(0, 0, 0);">
    <a href="#content">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
      ...
      <?php if ($logo or $site_name or $site_slogan): ?>
        <div id="logo-title">
          ...
          <?php if ($logo): ?>
            <div id="logo" style="background-image:url(<?php print $logo; ?>);"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home">
