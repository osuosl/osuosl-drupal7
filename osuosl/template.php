 ...
 *   entirety and paste it here, changing the prefix from theme_ to osuosl_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: osuosl_breadcrumb()
 *
 *   where osuosl is the name of your sub-theme. For example, the
...
if (theme_get_setting('osuosl_fixed')) {
 ...
 */
function osuosl_theme(&$existing, $type, $theme, $path) {
 ...
 */
/* -- Delete this line if you want to use this function
function osuosl_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function osuosl_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function osuosl_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
